...
if WINDOWS:
    ...
    if platform.python_implementation() == 'PyPy':
        raise RuntimeError('gevent & gipc are not supported on PyPy on Windows')
...
class _GIPCHandle(object):
    ...
    def _winapi_childhandle_prepare_transfer(self):
        ...
        module is part of multiprocessing in all CPython versions from 2.6.x to
        3.5.x. It is however not available in all PyPy versions.
